...
\begin{itemize}
  ...
  \item \textbf{Tradeoff between Space and Time}: The design choices made to optimise for parallelism may impact the filter's space efficiency and false-positive rate. Balancing these trade-offs to achieve an optimal configuration for specific use cases is a complex task that requires careful analysis and experimentation.
\end{itemize}
