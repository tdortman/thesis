...
The TCF relies heavily on shared memory for internal computations. It utilizes cooperative groups to load blocks into shared memory and perform intra-block sorting and coordination. Since shared memory physically resides within the L1 cache configuration on modern NVIDIA architectures, these accesses are recorded as L1 hits.
