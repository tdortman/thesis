...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=1.0\textwidth]{images/perf/insert_small.pdf}
  \vspace{0.2cm}
  \includegraphics[width=1.0\textwidth]{images/perf/insert_large.pdf}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=1.0\textwidth]{images/perf/query_small.pdf}
  \vspace{0.2cm}
  \includegraphics[width=1.0\textwidth]{images/perf/query_large.pdf}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=1.0\textwidth]{images/perf/delete_small.pdf}
  \vspace{0.2cm}
  \includegraphics[width=1.0\textwidth]{images/perf/delete_large.pdf}
