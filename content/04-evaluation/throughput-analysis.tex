...
The specific speedup multipliers and performance comparisons cited throughout this section represent the performance on System B (HBM3) with an 80\% target load factor as well as positive lookups.
