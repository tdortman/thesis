...
Figure \ref{fig:256bit-loads} compares the query throughput of the standard 128-bit load implementation against the optimized 256-bit variant on System A.

\begin{figure}[ht!]
  \centering
  \includegraphics[width=1.0\textwidth]{images/load-width-comparison.pdf}
  \caption{Query throughput comparison between 128-bit loads and 256-bit loads on System A.}
