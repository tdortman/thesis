...
This shows that the use of 256-bit vector loads offers a "free" performance boost for L2-resident workloads on supported hardware by improving instruction efficiency. However, it does not fix the memory bandwidth bottleneck of large, DRAM-resident Cuckoo filters.
