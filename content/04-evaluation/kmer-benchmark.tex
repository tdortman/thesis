...
\begin{itemize}
  ...
  \item \textbf{Insertion Performance}: While the Cuckoo filter trails the static Blocked Bloom filter in this high-bandwidth scenario, it remains the fastest among dynamic data structures, outperforming the TCF by 19\% and the GQF by 3.8$\times$. This reinforces the observation that the GQF's locking overhead is a severe bottleneck for insertion workloads.
