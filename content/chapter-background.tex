...
\begin{itemize}
  ...
  \item \textbf{Sub-optimal Space Usage}: The optimal space usage for a Bloom filter is approximately $1.44 \log_2(1/\epsilon)$ bits per element for a desired false positive rate $\epsilon$, which is $44\%$ higher than the information theoretical lower bound.
\end{itemize}
