...
\begin{itemize}
  ...
  \item \textbf{Comparison with TCF}: The GPU Cuckoo filter significantly outperforms the Bulk Two-Choice Filter (TCF) regarding accuracy. The TCF exhibits an error rate roughly an order of magnitude higher (ranging between 0.2\% and 0.5\%). While the TCF is more accurate than the Blocked Bloom filter, the Cuckoo filter and GQF designs offer superior accuracy for this workload.
\end{itemize}
