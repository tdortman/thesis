...
The performance evaluation was conducted on four distinct hardware configurations to analyse how different memory architectures impact the scalability of the filters. Systems C is only used for the comparison between sorted and unsorted insertion as well as the comparison of the two eviction policies.
