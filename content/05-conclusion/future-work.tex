...
\begin{itemize}
  \item \textbf{Asynchronous APIs}: The current IPC mechanism is blocking.
    Future iterations could implement an asynchronous command queue, similar to \texttt{io\_uring}, to allow clients to submit batches of requests without stalling, further maximizing GPU occupancy.
  ...
  \item \textbf{Integration into High-Throughput Systems}: While micro-benchmarks demonstrate raw speed, the ultimate validation would be integrating the library into real-world systems characterized by high churn.
