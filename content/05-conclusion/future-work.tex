...
\begin{itemize}
  ...
  \item \textbf{Optimisation for Heterogeneous Systems}: With the increasing prevalence of heterogeneous systems like the NVIDIA GH200, future work could investigate optimising the Cuckoo filter for such architectures.
    Specifically, leveraging unified memory to lower the cost of CPU-to-GPU data transfers could yield significant performance improvements.
\end{itemize}