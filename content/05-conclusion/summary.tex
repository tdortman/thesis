...
\begin{itemize}
  ...
  \item \textbf{Rigorous Evaluation}: A comprehensive analysis was conducted across different memory technologies (GDDR6X and HBM3). The results demonstrate that the implementation successfully bridges the gap between static and dynamic filters, offering update capabilities orders of magnitude faster than existing alternatives like the Quotient Filter while maintaining query throughput competitive with the Blocked Bloom filter.
\end{itemize}