...
\begin{itemize}
  \item \textbf{High-Performance CUDA Library}: The design and implementation of a parallel Cuckoo filter supporting insertion, lookup, and deletion are presented. The source code is available as an open-source header-only library.\footnote{Available at: \url{https://github.com/tiltedtoast/cuckoo-filter/}}
