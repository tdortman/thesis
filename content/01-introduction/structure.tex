...
This chapter presents a comprehensive empirical analysis of the implemented data structure. The filter is benchmarked against state-of-the-art CPU and GPU baselines across diverse hardware architectures. The evaluation covers throughput, memory efficiency, and hardware utilization, identifying key performance characteristics and architectural scaling behaviours in both cache-resident and DRAM-resident scenarios.
