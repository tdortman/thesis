...
Despite these advancements, the GQF is still bound by the architectural challenge of element shifting. While optimized for bulk updates, insertions remain difficult to parallelize. The necessity of shifting elements implies that insertion throughput is heavily dependent on the filter's load factor and the distribution of keys, potentially limiting performance compared to bucket-based approaches like the Cuckoo filter which rely on localized atomic swaps.
