...
\begin{enumerate}
  ...
  \item The evicted item $y$ is then reinserted into its alternate location. If $y$ was in $T_1$, it now attempts to move to $T_2[i_2]$. This move may, in turn, cause another eviction, leading to a chain of evictions.
