...
\newcommand{\thesisKeywords}{GPU Cuckoo Filter, CUDA, Approximate Membership Query, Probabilistic Data Structures, Parallel Computing}  % (optional) Keywords are added to PDF meta data

\newcommand{\thesisDate}{February 5, 2026} % automatically insert current date. Change to the submission date if you like. (Apparently, some people handed in their thesis with the wrong date because they did not change it here)
...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, positioning, calc, shadows.blur, decorations.pathreplacing, backgrounds, fit}
